      ...
      <nav className={`${styles["navbar"]} fixed w-full z-20 top-0 start-0 border-b border-gray-200 opacity-90`}>
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
              <div className="flex items-center lg:space-x-6">
                  ...
                  <div
                    className="flex ml-3.5 lg:ml-0 items-center justify-center text-xs flex-grow pointer-events-none">
                      ...
                      <div
                        className="ml-0.5 text-center border-2 border-dotted bg-gray-100 text-xs lg:text-sm font-bold rounded-lg flex flex-col items-center lg:px-4 lg:py-1 lg:ml-3 w-20 lg:w-44">
                          {fearGreed ? (
                            <>
              ...
              <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 relative"
                   id="navbar-sticky">
                  <ul
                    className="flex flex-col md:flex-row items-center md:space-x-0 font-medium rounded-lg md:mt-0 md:border-0 absolute right-80 h-full">
                      <li className="flex items-center h-full">
                          <Link href="/dashboard"
                                className={`flex items-center h-full px-3 text-dark md:hover:text-blue-700 hover:bg-gray-300 hover:text-blue-700 transition duration-300 ease-in-out ${router.pathname === "/dashboard" ? "border-b-2 border-blue-500" : ""}`}>
                              Home
                          </Link>
                      </li>
                      <li className="flex items-center h-full">
                          <Link href="/twitter"
                                className={`flex items-center h-full px-3 text-dark md:hover:text-blue-700 hover:bg-gray-300 hover:text-blue-700 transition duration-300 ease-in-out fs-3 fw-bold ${router.pathname === "/twitter" ? "border-b-2 border-blue-500" : ""}`}>
                              X
                          </Link>
                      </li>
                      <li className="flex items-center h-full">
                          <Link href="/news"
                                className={`flex items-center h-full px-3 text-dark md:hover:text-blue-700 hover:bg-gray-300 hover:text-blue-700 transition duration-300 ease-in-out ${router.pathname === "/news" ? "border-b-2 border-blue-500" : ""}`}>
                              News
                          </Link>
                      </li>
                      <li className="flex items-center h-full">
                          <Link href="/memecoin"
                                className={`flex items-center h-full px-3 text-dark md:hover:text-blue-700 hover:bg-gray-300 hover:text-blue-700 transition duration-300 ease-in-out ${router.pathname === "/memecoin" ? "border-b-2 border-blue-500" : ""}`}>
                              Memecoins
                          </Link>
                      </li>
                      <li className="flex items-center h-full">
                          <Link href="/nft"
                                className={`flex items-center h-full px-3 text-dark md:hover:text-blue-700 hover:bg-gray-300 hover:text-blue-700 transition duration-300 ease-in-out ${router.pathname === "/nft" ? "border-b-2 border-blue-500" : ""}`}>
                              NFTs
                          </Link>
                      </li>
                  </ul>
