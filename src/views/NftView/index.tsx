              ...
              <table className={styles.table}>
                <thead>
                  <tr>
                    ...
                    <th
                      onClick={() => requestSort("avgPriceChange")}
                      className={styles.sortableHeader}
                    >
                    ...
                    <th
                      onClick={() => requestSort("volumeChange")}
                      className={styles.sortableHeader}
                    >
                      Volume % {getSortIndicator("volumeChange")}
                    </th>
                    <th
                      onClick={() => requestSort("traders")}
                      className={styles.sortableHeader}
                    >
                      Traders {getSortIndicator("traders")}
                    </th>
                    <th
                      onClick={() => requestSort("tradersChange")}
                      className={styles.sortableHeader}
                    >
                    ...
                    <th
                      onClick={() => requestSort("salesChange")}
                      className={styles.sortableHeader}
                    >
                    ...
                    <tr key={nft.name}>
                      ...
                      <td>
                        <div className="flex items-center h-9">
                          ...
                          <div className="w-16 mr-1 lg:block lg:w-48 text-left truncate pointer-events-none">
                            {nft.name}
                          </div>
                          <div
                            className={`w-12 lg:w-20 flex justify-center ${
                              publicKey && uVotes.includes(nft.name)
                      ...
                      <td className="pointer-events-none">
                        {formatPrice(nft.avgPrice)}$
                      </td>
                      <td
                        className={`${
                          nft.avgPriceChange !== null && nft.avgPriceChange >= 0
                      ...
                      <td className="pointer-events-none">
                        {formatLargeNumber(nft.volumeUsd)}
                      </td>
                      <td
                        className={`${
                          nft.volumeChange !== null && nft.volumeChange >= 0
                            ? styles.priceChangePositive
                            : styles.priceChangeNegative
                        } pointer-events-none`}
                      >
                      ...
                      <td
                        className={`${
                          nft.tradersChange !== null && nft.tradersChange >= 0
                            ? styles.priceChangePositive
                            : styles.priceChangeNegative
                        } pointer-events-none`}
                      >
                      ...
                      <td
                        className={`${
                          nft.salesChange !== null && nft.salesChange >= 0
                            ? styles.priceChangePositive
                            : styles.priceChangeNegative
                        } pointer-events-none`}
                      >
